...
The professor is evaluating whether the group understands distributed systems and concurrency concepts — not whether the code is production-grade. Every implementation decision must be explainable to a professor in a 10-minute presentation.
